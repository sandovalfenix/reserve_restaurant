                    ...
                    o.popover({
                        ...
                        html: 
                            ...
                            content:'<div class="m-scheduler__event-heading pt-3">'+i.get(0).outerHTML+
                                    ...
                                    '<ul class="list-group">'+
                                      '<li class="list-group-item"><i class="fas fa-utensils"></i> Solicitud: <b>'+t.request+'</b></li>'+
                                      ...
                                      '<li class="list-group-item"><i class="fas fa-envelope"></i> Correo: <a href="mailto:'+t.email+'"><b>'+t.email+'</b></a></li>'+
                                       ...
                                       '<li class="list-group-item"><i class="fas fa-utensils"></i> Celebración: <b>'+t.description+'</b></li>'+
                                    '</ul>'+
                                    '</div>', 
