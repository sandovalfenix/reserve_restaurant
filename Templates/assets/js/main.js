(function($) {
  ...
  function select2() {
    ...
    function formatUsers(user) {
      ...
      var $user = $(
        '<span class="select-user__img"><img src="/Templates/assets/img/avatar/' + $('#select-user option:selected').attr('data-avatar') + '" /></span><span class="select-user__name">' + user.text + '</span>'
      );
      return $user;
    }
